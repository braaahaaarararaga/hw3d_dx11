...
bool PixelShader_::Initialize(Microsoft::WRL::ComPtr<ID3D11Device>& device, std::wstring shaderpath)
{
...
ID3D11PixelShader * PixelShader_::GetShader()
{
	return this->shader.Get();
}

ID3D10Blob * PixelShader_::GetBuffer()
{
